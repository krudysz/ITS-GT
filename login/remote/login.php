...
<style type="text/css"><!--
 ...
 a {color: black}
 table.login {border-collapse: collapse; border: 3px solid white;
  background-color: white}
 td.wbot { border-bottom: 3px solid white}
//-->
</style>
<script>
<!--
...
<!--  gtg111x <p> -->
<p>
<img src="/ece2025/cgi-bin/mimetex.exe?\Large\Longleftrightarrow" alt="o">
<br/>
<br/>
