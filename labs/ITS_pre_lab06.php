...
$lab_num   = 6;
$lab_title = 'Lab #'.$lab_num.': A/D and D/A Conversion';
$lab_intro = '<div style="margin:15px;">
...
$lab_sec_parts = array(5);
$lab_sec_ques = array(array(1,1,1,1,1));
$lab_sec_ans_rows = array(array(1,1,1,1,1));
