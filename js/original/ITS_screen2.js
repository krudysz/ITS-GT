...
//alert(err_msg.visibility);
  ...
  for (i=0; i<x.length; i++) {
	...
	*/
	...
	//--------------------------//
	ITS_AJAX('ITS_screen_AJAX2.php','recordChapterAnswer',qid+'~'+qtype+'~'+chosen,ITS_screen,'contentContainer'); //'contentContainer');
  ...
  ITS_AJAX('ITS_screen_AJAX2.php','message','<div id="errorContainerContent">Select an answer.</div>',ITS_screen,'errorContainer');
}*/
}
//-------------------------------------------------//
...
//-------------------------------------------------//
 ...
 ITS_AJAX('ITS_screen_AJAX2.php','getContent','',ITS_screen,'contentContainer');
}
//-------------------------------------------------//
function ITS_review_next(delta){
//-------------------------------------------------//
//alert(ITS_review_next);
 ITS_AJAX('ITS_screen_AJAX2.php','reviewMode',delta,ITS_screen,'reviewContainer');
}
//-------------------------------------------------//
...
if (chosen){
  ...
  ITS_AJAX('ITS_screen_AJAX.php','message','<span id="errorContainerContent">Select an answer.</span>',ITS_screen,'errorContainer');
}
}
//-------------------------------------------------//
